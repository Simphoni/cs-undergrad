...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "C:\\Users\\xjzjo\\Desktop\\worker\\cod\\a.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "C:\\Users\\xjzjo\\Desktop\\worker\\cod\\a.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径
  parameter FLASH_INIT_FILE = "C:\\Users\\xjzjo\\Desktop\\worker\\cod\\a.bin";  // Flash 初始化文件，请修改为实际的绝对路径
