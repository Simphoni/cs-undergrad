...
module lab5_tb;
  ...
  parameter BASE_RAM_INIT_FILE = "C:\\Users\\xjzjo\\Desktop\\worker\\cod\\kernel.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "C:\\Users\\xjzjo\\Desktop\\worker\\cod\\kernel.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  ...
  initial begin
    ...
    for (integer i = 0; i < 20; i = i + 1) begin
      ...
      uart.pc_send_byte(8'h30); // ASCII '2'
      #100;  // 等待 100ns
